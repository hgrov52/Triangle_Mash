...
How do recalculate edges and add edge get access to the priority queue
Do we make the queue private data? where, there are no private and public definitions

is it helpful to make a swap function for the percolations in priority queue?

Q in recalculate edges of mesh.cpp.
